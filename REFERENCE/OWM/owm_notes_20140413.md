...
1. `utils.construct_OWM_api_req()` now working: appid must go last in query. I do not see 14 days of forecast — only to 2014-04-18 00:00:00 when made on 2014-04-13.
