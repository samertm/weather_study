...
def makeMap(lonStart,lonEnd,latStart,latEnd,name,stLon,stLat):
 ...
 #   bathySmoothed = laplaceFilter.laplace_filter(bathy,M=None)
    bathySmoothed = scipy.ndimage.filters.laplace(bathy)
  
    levels=[-6000,-5000,-3000, -2000, -1500, -1000,-500, -400, -300, -250, -200, -150, -100, -75, -65, -50, -35, -25, -15, -10, -5, 0, 5, 10, 25, 30, 35, 50, 65, 75, 100, 150, 200, 250, 300, 400, 500, 1000, 1500, 2000, 3000, 5000, 6000]
